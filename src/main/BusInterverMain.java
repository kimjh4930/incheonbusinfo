...
public class BusInterverMain {
	...
	static BusIntervalModel prevBusInfo = new BusIntervalModel();
	...
	public static void runtest() throws IOException, InterruptedException {
		...
		busInfoList 	= parser.getBusGapInfo(html);		//7016159;1923;13;3;7016111;983;0
...
//					+ "\t\t버스간격 : " + busInfoModelList.get(i).getBusInterval());
		...
		write.BusIntervalWrite(busInfoModelList);
